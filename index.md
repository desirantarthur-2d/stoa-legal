...
Stoa est une application mobile éditée par Arthur Désirant, personne physique, basée en Belgique.

Pour toute question relative à cette politique ou à vos données personnelles, vous pouvez nous contacter à : **stoa.arthur@gmail.com**
...
- Prénom
- Âge (facultatif)
- Métier ou situation (facultatif)
- Informations que vous choisissez de partager pour personnaliser votre expérience : votre principal défaut, un échec récent, ce dont vous avez besoin

Ces informations servent uniquement à personnaliser les analyses et le contenu du mentor virtuel. Elles ne sont jamais partagées avec d'autres utilisateurs.
...
- Informations de transaction gérées par Apple (App Store) et notre prestataire de gestion d'abonnements RevenueCat — nous ne recevons jamais vos informations de carte bancaire directement

### 2.6 Contenu généré
- Texte des analyses personnalisées générées par intelligence artificielle à partir de votre profil
- Fichiers audio générés temporairement pour la lecture vocale du mentor (non stockés de façon permanente)
...
- Personnaliser les citations et analyses quotidiennes
- Générer la voix du mentor vocal
...
Pour faire fonctionner l'application, certaines données transitent par des prestataires techniques, chacun soumis à ses propres obligations de confidentialité :
...
Ces prestataires n'utilisent vos données que pour fournir leur service technique à Stoa, pas à leurs propres fins commerciales.
...
Conformément à la législation belge (qui fixe l'âge de consentement numérique à 13 ans, comme le permet le RGPD), Stoa n'est pas destinée aux enfants de moins de 13 ans. Nous ne collectons pas sciemment de données auprès d'enfants de moins de 13 ans sans le consentement d'un parent ou tuteur légal. Si vous pensez qu'un enfant de moins de 13 ans nous a fourni des données personnelles sans ce consentement, contactez-nous pour une suppression immédiate.

---

## 10. Modifications de cette politique

Nous pouvons mettre à jour cette politique de confidentialité de temps à autre. Toute modification importante vous sera notifiée via l'application.
